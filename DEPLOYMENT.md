...
sh src/os-mihomo/tests/jail/run.sh \
  src/os-mihomo/dist/FreeBSD:15:amd64/os-mihomo-1.2.8.pkg legacy-1.0.2.pkg
```
...
SOURCE_COMMIT=<tested-40-character-commit> \
  ...
  sh build-repo.sh src/os-mihomo/dist/FreeBSD:15:amd64/os-mihomo-1.2.8.pkg \
    src/os-sing-box/dist/os-sing-box-1.1.3.pkg \
