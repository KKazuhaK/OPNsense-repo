...
require_once($argv[1] ?? dirname(__DIR__, 2) . '/src/usr/local/etc/inc/plugins.inc.d/sing_box.inc');
...
tun_singbox: flags=8043<UP,BROADCAST,RUNNING,MULTICAST>
    inet 198.18.0.1 netmask 0xfffffffc broadcast 198.18.0.3
DATA);
$context = sing_box_routing_context($mapping, $lines);
