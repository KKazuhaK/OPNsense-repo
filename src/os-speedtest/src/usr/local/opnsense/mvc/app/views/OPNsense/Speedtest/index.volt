<style>
.speedtest-summary {display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:15px;margin-bottom:15px}
...
.speedtest-table {table-layout:fixed}
.speedtest-label {width:25%}
.speedtest-table > thead > tr > th {padding-right:10px}
.speedtest-table > tbody > tr > th {padding-left:10px}
.speedtest-control {max-width:480px;width:100%}
.speedtest-refresh {margin:10px 0 0}
.speedtest-actions {display:flex;flex-wrap:wrap;align-items:center;gap:10px;margin-top:15px;padding:15px}
.speedtest-actions:before,.speedtest-actions:after {content:none}
...
@media(max-width:1199px) {.speedtest-summary {grid-template-columns:repeat(6,minmax(0,1fr))} .speedtest-metric {grid-column:span 2} .speedtest-metric:nth-child(n+4) {grid-column:span 3} .speedtest-label {width:160px}}
@media(max-width:480px) {.speedtest-metric {padding:10px} .speedtest-metric strong {font-size:20px} .speedtest-label {width:40%}}
@media(max-width:359px) {.speedtest-label {width:35%}}
</style>
<div class="alert alert-danger hidden __mb" id="speedtest-error" role="alert"></div>
<div class="alert alert-info hidden __mb" id="speedtest-status"><i class="fa fa-spinner fa-spin speedtest-icon"></i><strong data-t="running"></strong><ul id="speedtest-stages" class="speedtest-stages"></ul></div>
...
<div class="content-box __mb hidden" id="speedtest-result"><table class="table table-striped table-condensed speedtest-table"><colgroup><col class="speedtest-label"><col></colgroup><thead><tr><th colspan="2" data-t="result"></th></tr></thead><tbody>
...
<form id="frm_speedtest"><div class="content-box"><table class="table table-striped table-condensed speedtest-table"><colgroup><col class="speedtest-label"><col></colgroup><thead><tr><th colspan="2"><span data-t="settings"></span><span class="pull-right"><small data-t="full_help">{{ lang._('full help') }}</small> <a href="#"><i class="fa fa-toggle-off text-danger" id="speedtest_show_all_help"></i></a></span></th></tr></thead><tbody>
...
<p class="speedtest-refresh"><button class="btn btn-default" type="button" id="refresh-servers"><i class="fa fa-refresh speedtest-icon"></i><span data-t="refresh"></span></button></p>
...
<div class="content-box speedtest-actions"><button class="btn btn-primary" type="submit" id="run-test"><i class="fa fa-tachometer speedtest-icon"></i><span data-t="run"></span></button> <button class="btn btn-default" type="button" id="clear-result"><i class="fa fa-trash speedtest-icon"></i><span data-t="clear"></span></button></div>
</form>
<script>
$(function () {
